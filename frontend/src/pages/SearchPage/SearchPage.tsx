    ...
    <main className="w-full min-h-[100vh] bg-cpc-blue">
      <div className="h-full flex justify-center items-center flex-col py-5">
        ...
        <span className="w-3/5 flex flex-row justify-evenly items-center mb-8">
          <p
            className={`w-2/5 flex place-content-center font-dm-mono text-2xl ${state === "whisper" ? "font-medium text-cpc-orange" : "font-light text-white"} [text-shadow:0px_4px_4px_var(--tw-shadow-color)] shadow-black/25 hover:scale-[105%] hover:[text-shadow:5px_5px_10px_var(--tw-shadow-color)] duration-300 ease-in-out cursor-pointer`}
          ...
          <p
            className={`w-2/5 flex place-content-center font-dm-mono text-2xl ${state === "group" ? "font-medium text-cpc-orange" : "font-light text-white"} [text-shadow:0px_4px_4px_var(--tw-shadow-color)] shadow-black/25 hover:scale-[105%] hover:[text-shadow:5px_5px_10px_var(--tw-shadow-color)] duration-300 ease-in-out cursor-pointer`}
